...
JavaScript (ES6+), TypeScript (^3), Python (^3.6), _C/C++, Java, Scala, Go_

### Web Frontend Frameworks & Libraries

React (w/ hooks, query, suspense), Redux (w/ Saga, Observable), Next, Gatsby, Storybook, Jest, _Vue(Vuex, Nuxt), Angular_
...
AWS (EC2, RDS, Route53, S3, CloudFront, VPC, IAM, _ECS, ECR, ALB_), Netlify, Vercel, MongoDB Atlas, _GCP, Firebase_
...
Slack, Notion, _Jira & Confluence_
