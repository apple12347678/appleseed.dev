...
type SitePageContext = {
  ...
  readonly postsPerPage: Scalars['Int'];
...
type SitePageContextPosts = {
  readonly excerpt: Maybe<Scalars['String']>;
  readonly fields: Maybe<SitePageContextPostsFields>;
  readonly frontmatter: Maybe<SitePageContextPostsFrontmatter>;
  readonly timeToRead: Maybe<Scalars['Int']>;
};

type SitePageContextPostsFields = {
  readonly slug: Maybe<Scalars['String']>;
};

type SitePageContextPostsFrontmatter = {
...
type SitePluginPluginOptions = {
  ...
  readonly footnoteBackRefPreviousElementDisplay: Maybe<Scalars['String']>;
  readonly footnoteBackRefDisplay: Maybe<Scalars['String']>;
  readonly footnoteBackRefInnerText: Maybe<Scalars['String']>;
  readonly footnoteBackRefInnerTextStartPosition: Maybe<Scalars['String']>;
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.fields.lang'
  ...
  | 'childMarkdownRemark.fields.lang'
...
type SitePageContextPostsFilterInput = {
  readonly excerpt: Maybe<StringQueryOperatorInput>;
  readonly fields: Maybe<SitePageContextPostsFieldsFilterInput>;
  readonly frontmatter: Maybe<SitePageContextPostsFrontmatterFilterInput>;
  readonly timeToRead: Maybe<IntQueryOperatorInput>;
};

type SitePageContextPostsFieldsFilterInput = {
  readonly slug: Maybe<StringQueryOperatorInput>;
};

type SitePageContextPostsFrontmatterFilterInput = {
...
type SitePluginPluginOptionsFilterInput = {
  ...
  readonly footnoteBackRefPreviousElementDisplay: Maybe<StringQueryOperatorInput>;
  readonly footnoteBackRefDisplay: Maybe<StringQueryOperatorInput>;
  readonly footnoteBackRefInnerText: Maybe<StringQueryOperatorInput>;
  readonly footnoteBackRefInnerTextStartPosition: Maybe<StringQueryOperatorInput>;
...
type SitePageFieldsEnum =
  ...
  | 'context.i18n.path'
  | 'context.posts'
  | 'context.posts.excerpt'
  | 'context.posts.fields.slug'
  | 'context.posts.frontmatter.date'
  | 'context.posts.frontmatter.title'
  | 'context.posts.frontmatter.description'
  | 'context.posts.frontmatter.tags'
  | 'context.posts.timeToRead'
  | 'context.pageIndex'
  | 'pluginCreator.id'
  ...
  | 'pluginCreator.pluginOptions.footnoteBackRefPreviousElementDisplay'
  | 'pluginCreator.pluginOptions.footnoteBackRefDisplay'
  | 'pluginCreator.pluginOptions.footnoteBackRefInnerText'
  | 'pluginCreator.pluginOptions.footnoteBackRefInnerTextStartPosition'
...
type TagConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<TagEdge>;
  ...
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<TagGroupConnection>;
};


type TagConnection_distinctArgs = {
  field: TagFieldsEnum;
};


type TagConnection_maxArgs = {
  field: TagFieldsEnum;
};


type TagConnection_minArgs = {
  field: TagFieldsEnum;
};


type TagConnection_sumArgs = {
  field: TagFieldsEnum;
};


type TagConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: TagFieldsEnum;
};
...
type TagEdge = {
  readonly next: Maybe<Tag>;
  readonly node: Tag;
  readonly previous: Maybe<Tag>;
};
...
type TagSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<TagFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type SitePluginFieldsEnum =
  ...
  | 'pluginOptions.plugins.pluginOptions.footnoteBackRefPreviousElementDisplay'
  | 'pluginOptions.plugins.pluginOptions.footnoteBackRefDisplay'
  | 'pluginOptions.plugins.pluginOptions.footnoteBackRefInnerText'
  | 'pluginOptions.plugins.pluginOptions.footnoteBackRefInnerTextStartPosition'
  ...
  | 'pluginOptions.footnoteBackRefPreviousElementDisplay'
  | 'pluginOptions.footnoteBackRefDisplay'
  | 'pluginOptions.footnoteBackRefInnerText'
  | 'pluginOptions.footnoteBackRefInnerTextStartPosition'
...
type HomeDataQueryVariables = Exact<{
  language: Scalars['String'];
  postsPerPage: Scalars['Int'];
}>;


type HomeDataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly locales: { readonly edges: ReadonlyArray<{ readonly node: Pick<Locale, 'ns' | 'data' | 'language'> }> }, readonly file: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<(
      Pick<MarkdownRemark, 'excerpt' | 'timeToRead'>
      & { readonly fields: Pick<Fields, 'slug'>, readonly frontmatter: Pick<Frontmatter, 'date' | 'title' | 'description' | 'tags'> }
    )> }, readonly allSitePage: { readonly nodes: ReadonlyArray<Pick<SitePage, 'path'>> } };

type PageByIndexQueryVariables = Exact<{
  language: Scalars['String'];
}>;


type PageByIndexQuery = { readonly locales: { readonly edges: ReadonlyArray<{ readonly node: Pick<Locale, 'ns' | 'data' | 'language'> }> } };
...
type BlogPostBySlugQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly locales: { readonly edges: ReadonlyArray<{ readonly node: Pick<Locale, 'ns' | 'data' | 'language'> }> }, readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'timeToRead' | 'html'>
    & { readonly frontmatter: Pick<Frontmatter, 'title' | 'date' | 'description' | 'tags'> }
  )>, readonly previous: Maybe<{ readonly fields: Pick<Fields, 'slug'>, readonly frontmatter: Pick<Frontmatter, 'title'> }>, readonly next: Maybe<{ readonly fields: Pick<Fields, 'slug'>, readonly frontmatter: Pick<Frontmatter, 'title'> }> };
