...
export type SitePluginPluginOptionsI18nextOptions = {
  ...
  keySeparator?: Maybe<Scalars['Boolean']>;
...
export type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark___fields___lang'
...
export type SitePageContextFilterInput = {
  ...
  isLastPage?: Maybe<BooleanQueryOperatorInput>;
  ...
  pageIndex?: Maybe<IntQueryOperatorInput>;
};
...
export type SitePluginPluginOptionsI18nextOptionsFilterInput = {
  ...
  keySeparator?: Maybe<BooleanQueryOperatorInput>;
...
export type SitePageFieldsEnum =
  ...
  | 'context___posts___fields___slug'
  | 'context___posts___frontmatter___date'
  | 'context___posts___frontmatter___title'
  | 'context___posts___frontmatter___description'
  | 'context___posts___frontmatter___tags'
  | 'context___posts___timeToRead'
  | 'context___pageIndex'
  | 'pluginCreator___id'
  ...
  | 'pluginCreator___pluginOptions___footnoteBackRefPreviousElementDisplay'
  | 'pluginCreator___pluginOptions___footnoteBackRefDisplay'
  | 'pluginCreator___pluginOptions___footnoteBackRefInnerText'
  | 'pluginCreator___pluginOptions___footnoteBackRefInnerTextStartPosition'
...
export type SitePluginFieldsEnum =
  ...
  | 'pluginOptions___plugins___pluginOptions___footnoteBackRefPreviousElementDisplay'
  | 'pluginOptions___plugins___pluginOptions___footnoteBackRefDisplay'
  | 'pluginOptions___plugins___pluginOptions___footnoteBackRefInnerText'
  | 'pluginOptions___plugins___pluginOptions___footnoteBackRefInnerTextStartPosition'
  ...
  | 'pluginOptions___footnoteBackRefPreviousElementDisplay'
  | 'pluginOptions___footnoteBackRefDisplay'
  | 'pluginOptions___footnoteBackRefInnerText'
  | 'pluginOptions___footnoteBackRefInnerTextStartPosition'
...
export type HomeDataQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, locales: { edges: Array<{ node: Pick<Locale, 'ns' | 'data' | 'language'> }> }, file?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }>, allMarkdownRemark: { nodes: Array<(
      Pick<MarkdownRemark, 'excerpt' | 'timeToRead'>
      & { fields: Pick<Fields, 'slug'>, frontmatter: Pick<Frontmatter, 'date' | 'title' | 'description' | 'tags'> }
    )> }, allSitePage: { nodes: Array<Pick<SitePage, 'path'>> } };
...
export type BlogPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, locales: { edges: Array<{ node: Pick<Locale, 'ns' | 'data' | 'language'> }> }, markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'timeToRead' | 'html'>
...
export type PageByIndexQueryVariables = Exact<{
  language: Scalars['String'];
}>;


export type PageByIndexQuery = { locales: { edges: Array<{ node: Pick<Locale, 'ns' | 'data' | 'language'> }> } };
